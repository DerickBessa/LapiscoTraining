### this file is for viewing the answers of the questions to remove somo confusion!import cv2
import numpy as np
...
grayscale_image = cv2.imread('image.jpg')
...
if __name__ == '__main__':
    ...
    cv2.resizeWindow('Mark object 1', 640, 480)
